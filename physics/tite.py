...
def titspalex(rgr,Bpole,g14,DeltaM_M):
    ...
    titeeee = open('data/tite_table.dat', 'w')
    B12=Bpole/1.0e12
    ...
    for IT in range(1,MAXTb+1):
        ...
        for DeltaM_M,iii in zip([1e-10, 2e-10, 3.e-10, 4.e-10, 5e-10, 6e-10, 7e-10, 8.e-10, 9.e-10, 1.e-9, 1.e-8, 1.e-7, 1.e-6],range(13)):
            ...
            F1=numpy.log10(Te) # LOG of the magnetic Te
            T_s[iii] = F1
        titeeee.write('%6.3f %7.5f %7.5f %7.5f %7.5f %7.5f %7.5f %7.5f %7.5f %7.5f %7.5f %7.5f %7.5f %7.5f  \n' %(numpy.log10(Tb9)+9.0, T_s[0], T_s[1], T_s[2], T_s[3], T_s[4], T_s[5], T_s[6], T_s[7],
                                                                                                                                                               T_s[8], T_s[9], T_s[10], T_s[11], T_s[12]))
